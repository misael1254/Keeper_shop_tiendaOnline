...
<html lang=&quot;es&quot;>
     <head>
        ...
        <style>
            ...
            body {max-width:100%; _width: 100%; padding: 30px 20px 50px; border: 1px solid #b3b3b3;
    ...
    <body>
        <div class=&quot;container&quot; style="color: #fff">
            <h2><span>ERROR 404 <br></span>
                <h2><span><i class="fas fa-spinner fa-spin"></i></span></h2>
            Error interno del servidor</h2>
            <p>¡Vaya! Algo salió mal.<br /><br />Trata de volver a cargar otra  página o no dudes en contactar con nosotros si el problema persiste.</p>
            <a href="?p=inicio">REGRESAR</a>
        </div>
    </body>